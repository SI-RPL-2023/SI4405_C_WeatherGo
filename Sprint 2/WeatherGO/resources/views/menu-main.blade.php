<div class="card rounded-0 bg-31" data-card-height="150">
    <div class="card-top">
...
<div class="list-group list-custom-small list-menu">
    ...
    <a id="nav-contact" href="{{route('discuss')}}">
        <i class="fa font-12 fa-message rounded-sm bg-pink-dark color-white"></i>
        <span>Disqus</span>
        <i class="fa fa-angle-right"></i>
    </a>
    @if (Auth::user()->role == '1')
        <a id="nav-contact" href="{{route('admin')}}">
            <i class="fa fa-tasks font-14 bg-orange-dark color-white rounded-sm shadow-xl"></i>
                        <span>Admin</span>
                        <i class="fa fa-angle-right"></i>
        </a>
    @endif
    ...
    document.getElementById('logout-form').submit();">
        <i class="fa font-12 fa-sign-out rounded-sm bg-green-dark color-white"></i>
        <span>Logout</span>
        <i class="fa fa-angle-right"></i>
    </a>
