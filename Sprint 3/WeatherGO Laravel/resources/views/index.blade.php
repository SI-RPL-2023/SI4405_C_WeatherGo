        ...
        <div class="page-content">
            ...
            <div class="col-sm-6">
              <div class="card">
                <a href="" id="car">
                    ...
                    <center>
                        <img src="{{asset('images/carmode.png')}}" width="20%">
                        <h1 id="ba">Car Mode</h1>
                    </center>
                    </div>
                </a>
              </div>
            ...
            <div class="col-sm-6">
              <div class="card">
                <a href="" id="motor">
                    ...
                    <center>
                        <img src="{{asset('images/motormode.png')}}" width="20%">
                        <h1 id="ab">Motor Mode</h1>
                    </center>
                    </div>
                </a>
              </div>
                ...
                <div class="splide__track">
                    <div class="splide__list">
                        <div class="splide__slide">
                            <div class="card mx-3 rounded-m" id="g1">
                                <div data-card-height="150" class="card mx-3 bg-35 rounded-m shadow-l"
                                    style="margin-top: 30px">
                                    <div class="card-bottom text-center mb-4">
                                        <h2 class="color-white text-uppercase font-900">Motorcycle Mode</h2>
                                    </div>
                        ...
                        <div class="splide__slide">
                            <div class="card mx-3 rounded-m" id="g2">
                                <div data-card-height="150" class="card mx-3 bg-36 rounded-m shadow-l"
                                    style="margin-top: 30px">
                                    <div class="card-bottom text-center mb-4">
                                        <h2 class="color-white text-uppercase font-900">Car Mode</h2>
                                    </div>
                                    <div class="card-overlay bg-gradient"></div>
                                </div>
                            </div>
            ...
            <script>
                ...
                g1.addEventListener('click', function() {
                    g1.style.backgroundColor = "#52595D";
                    g2.style.backgroundColor = "#ffffff";
                });
                g2.addEventListener('click', function() {
                    g2.style.backgroundColor = "#52595D";
                ...
                <div class="col-8 pt-1">
                    <div class="card card-style shadow-xl">
                        <div class="content">
                            ...
                            <h1 class="font-24 font-700 mb-2">WeatherGO<i
                                    class="fa fa-star mt-n2 font-30 color-yellow-dark float-end me-2 scale-box"></i>
                            </h1>
                            <p class="mb-1">
                                This application will make it easier for users to find out the route to the destination.
                                in addition, users will also get developments regarding the weather in an area.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="content">
                            ...
                            <script>
                                ...
                                window.myWidgetParam.push({
                                    id: 14,
                                    cityid: '1650357',
                                    appid: 'c222fd5d12e787f24c4b06841b216464',
                                    units: 'metric',
                            ...
                            <a href="{{ route('weather') }}"
                                class="btn btn-sm rounded-s font-10 font-400 gradient-highlight btn-center-l">Check
                                Weather</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-style shadow-xl">
                <div class="row me-0 ms-0">
                    <div class="col-6 pt-3">
                        <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/37i9dQZF1E4FhRRLh0mmxG?utm_source=generator" width="100%" height="456" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                    ...
                    <div class="col-6 pt-3">
                        <div id="map" style="border-radius:12px; width: max; height: 455px;"></div>
                        <p id="loc"></p>
                        <script src="https://unpkg.com/leaflet@1.2.0/dist/leaflet.js"></script>
                        <script src="{{ asset('routing/dist/leaflet-routing-machine.js') }}"></script>
                        <script>
                            var map = L.map('map');
                            ...
                            L.Routing.control({
                                waypoints: [
                                    L.latLng(-6.972929, 107.632301),
                                    L.latLng(-6.922046, 107.607592)
                                ],
                        ...
                        <p class="mb-n1 color-highlight font-600">Locatio</p>
                        <h1>Maps</h1>
