        ...
        <div class="card-bottom ps-3 pb-3">
            ...
            <div class="d-flex">
                ...
                <div class="pe-3">
                    ...
                    <h6 class="color-white opacity-60">Feedback</h6>
                </div>
            </div>
        </div>
    ...
    <div class="content mt-0 mb-0">
        <div class="row mb-0">
            <div class="col-6">
                <div class="card mx-0 card-style" data-card-height="260">
                    <div class="content">
                        ...
                        <div class="mb-4">
                            <h5>Memor<span class="opacity-30 float-end">30%</span></h5>
            ...
            <div class="col-6">
                <div class="card mx-0 card-style" data-card-height="260">
                    <div class="content">
                        <h5 class="font-14 opacity-50">Running<a href="#" class="float-end color-highlight"><i class="fa fa-arrow-right"></i></a></h5>
                        <div class="divider mb-3"></div>
                    </div>
