...
<div class="list-group list-custom-small list-menu">
    ...
    <a id="nav-contact" href="{{route('contact')}}">
        <i class="fa fa-envelope gradient-teal color-white"></i>
        <span>Contact</span>
        <i class="fa fa-angle-right"></i>
    </a>
    <a id="nav-contact" href="{{route('discuss')}}">
        <i class="fa font-12 fa-message rounded-sm bg-green-dark"></i>
        <span>Disqus</span>
        <i class="fa fa-angle-right"></i>
    </a>
    <a id="nav-contact" href="{{route('replied')}}">
        <i class="fa font-12 fa-mail-reply rounded-sm gradient-brown color-white"></i>
        <span>Feedback Reply</span>
        <i class="fa fa-angle-right"></i>
    </a>
    @if (Auth::user()->role == '1')
        <a id="nav-contact" href="{{route('admin')}}">
            <i class="fa fa-tasks font-14 bg-teal-dark color-white rounded-sm shadow-xl"></i>
                        <span>Admin</span>
                        <i class="fa fa-angle-right"></i>
        </a>
    @endif
    <a id="nav-media" href="{{ route('logout') }}" onclick="event.preventDefault();
    document.getElementById('logout-form').submit();">
        <i class="fa font-12 fa-sign-out rounded-sm bg-green-dark"></i>
        <span>Logout</span>
        <i class="fa fa-angle-right"></i>
    </a>
