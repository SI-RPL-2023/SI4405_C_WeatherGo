...
Route::get('/reply/{id}', [App\Http\Controllers\HomeController::class, 'reply'])->name('reply');
...
Route::post('/reply/{id}', [App\Http\Controllers\HomeController::class, 'storeReply'])->name('storeReply');
Route::get('/delete/{id}', [App\Http\Controllers\HomeController::class, 'deleteReply'])->name('deleteReply');
Route::post('/feed', [App\Http\Controllers\HomeController::class, 'storeFeed'])->name('storeFeed');
Route::get('/disqus', [App\Http\Controllers\HomeController::class, 'discuss'])->name('discuss');
Route::get('/feedback-reply', [App\Http\Controllers\HomeController::class, 'feedbackReply'])->name('replied');
